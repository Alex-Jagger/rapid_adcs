...
right_ascension_sun_ref = 11.13925*conv.DEG2RAD;
declination_sun_ref = 4.788417*conv.DEG2RAD;
...
if(abs(right_ascension_sun_ref - right_ascension_sun)/abs(right_ascension_sun_ref) < 0.005)
    disp("pass")
else
    disp("fail")
end
